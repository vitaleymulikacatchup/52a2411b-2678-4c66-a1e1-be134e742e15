...
export const metadata: Metadata = {
  title: "Advokaadibüroo Tallinn - Usaldusväärne õigusabi Eestis",
  description: "Kogenud advokaadid Tallinnas. Äriõigus, tsiviilõigus, juriidiline nõustamine. Broneerige tasuta konsultatsioon. Professionaalne õigusabi eesti keeles.",
  keywords: "advokaat Tallinn, õigusabi Eesti, äriõigus, tsiviilõigus, juriidiline nõustamine, advokaadibüroo",
  metadataBase: new URL('http://localhost:3000'),
  alternates: {
    canonical: 'http://localhost:3000'
  },
  openGraph: {
    title: "Advokaadibüroo Tallinn - Usaldusväärne õigusabi",
    description: "Kogenud advokaadid Tallinnas pakuvad professionaalset õigusabi äri-, tsiviil- ja kriminaalõiguse valdkondades.",
    siteName: "Advokaadibüroo",
    type: "website",
    images: [{
      url: "https://images.pexels.com/photos/6170859/pexels-photo-6170859.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
      alt: "Kaasaegne advokaadibüroo"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Advokaadibüroo Tallinn - Usaldusväärne õigusabi",
    description: "Professionaalne õigusabi Tallinnas. Broneerige tasuta konsultatsioon.",
    images: ["https://images.pexels.com/photos/6170859/pexels-photo-6170859.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
